...
If you've not yet installed the Dosu GitHub app, you'll notice there are no repositories to choose from.
...
Back on the select target page, you should now see the repositories you've installed Dosu on.
...
Each setting has a short explanation of what it does in the UI, but for a more detailed explanation of each setting, see the [GitHub Workspace Configuration](/pages/github-configuration) page.
