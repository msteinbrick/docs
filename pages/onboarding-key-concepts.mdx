...
<Tabs>
  <Tab title='Workspace'>
    ...
    In the app, see the [Workspaces page](https://app.dosu.dev/workspaces) to view all your organization's workspaces:
  ...
  <Tab title='Data Source'>
    ...
    In the app, see the [Data Sources page](https://app.dosu.dev/data-sources) to view all your organization's data sources:
