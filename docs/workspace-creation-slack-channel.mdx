...
<Note>
It's recommended you first complete the [GitHub Repository Workspace Creation Guide](/docs/workspace-creation-github-repository)
</Note>
...
You'll be redircet to the Slack app installation page where you'll select from the top left the Slack workspace you'd like to install on.
![Workspace Guide 3](/images/workspace-guide-slack-3.png)

After allowing accses you'll be directed back to the app
